...
public:
    ...
    void Update(const sf::Vector2i &mousePos, bool leftMouseDown, bool leftMouseReleased, float scrollDelta, const std::map<ResourceType, MarketCommodity> &market, const City *activeCity);
    void Draw(sf::RenderWindow *window);
    void SetPosition(sf::Vector2f newPos);
    bool Contains(const sf::Vector2f &point) const;

    bool isVisible = false;
    const City *activeCityContext = nullptr;
